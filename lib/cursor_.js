...
(function() {
  var COMPARATORS, COMPARATOR_KEYS, Knex, SqlAst, SqlCursor, _, _appendCondition, _appendConditionalWhere, _appendWhere, _columnName, _extractCount, ref, sync,
  ...
  module.exports = SqlCursor = (function(superClass) {
    ...
    SqlCursor.prototype.queryToJSON = function(callback) {
      var $columns, $fields, ast, base, err, error, from_columns, i, key, len, query, rank_field, ref1, ref2, ref3, related_model_type, related_wheres, relation, sort_dir, sort_field, subquery, to_columns;
