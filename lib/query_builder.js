...
(function() {
  var _, appendLimits, appendSelect, appendSort, appendWhere, buildQueryFromAst, joinToRelation;
  ...
  joinToRelation = function(query, relation, options) {
    var from_key, model_type, pivot_from_key, pivot_table, pivot_to_key, related_model_type, to_key;
    if (options == null) {
      options = {};
    }
