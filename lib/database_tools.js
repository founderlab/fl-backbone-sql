...
(function() {
  ...
  module.exports = DatabaseTools = (function() {
    ...
    DatabaseTools.prototype.resetSchema = function(options, callback) {
      ...
      queue.defer((function(_this) {
        return function(callback) {
          return _this.connection.knex().schema.dropTableIfExists(_this.table_name).asCallback(callback);
        };
      })(this));
      queue.defer((function(_this) {
        return function(callback) {
    ...
    DatabaseTools.prototype.addColumn = function(table, column_info) {
      var column, column_args, column_method, constructor_options;
    ...
    DatabaseTools.prototype.hasColumn = function(column, callback) {
      return this.connection.knex().schema.hasColumn(this.table_name, column).asCallback(callback);
    };

    DatabaseTools.prototype.hasTable = function(callback) {
      return this.connection.knex().schema.hasTable(this.table_name).asCallback(callback);
    };

    DatabaseTools.prototype.dropTable = function(callback) {
      return this.connection.knex().schema.dropTable(this.table_name).asCallback(callback);
    };

    DatabaseTools.prototype.dropTableIfExists = function(callback) {
      return this.connection.knex().schema.dropTableIfExists(this.table_name).asCallback(callback);
    };

    DatabaseTools.prototype.renameTable = function(to, callback) {
      return this.connection.knex().schema.renameTable(this.table_name, to).asCallback(callback);
    };
