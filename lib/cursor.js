...
(function() {
  ...
  module.exports = SqlCursor = (function(superClass) {
    ...
    SqlCursor.prototype.runQuery = function(query, ast, callback) {
      ...
      return query.exec((function(_this) {
        return function(err, json) {
          ...
          if (_this._cursor.$count || _this._cursor.$exists) {
            count = extractCount(json);
            return callback(null, _this._cursor.$count ? count : count > 0);
          }
          if (ast.prefix_columns) {
            json = _this.unjoinResults(json, ast, _this.backbone_adapter.nativeToAttributes);
          }
    ...
    SqlCursor.prototype.fetchIncludedRelations = function(json, ast, callback) {
      ...
      return relation_query.exec((function(_this) {
        return function(err, raw_relation_json) {
          ...
          relation_json = _this.unjoinResults(raw_relation_json, relation_ast, _this.backbone_adapter.nativeToAttributes);
    ...
    SqlCursor.prototype.unjoinResults = function(raw_json, ast, parseJson) {
