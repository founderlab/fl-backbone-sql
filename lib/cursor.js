...
(function() {
  ...
  module.exports = SqlCursor = (function(superClass) {
    ...
    SqlCursor.prototype.queryToJSON = function(callback) {
      var $columns, $fields, base, err, error, from_columns, i, key, len, query, rank_field, ref1, ref2, ref3, related_model_type, related_wheres, relation, sort_dir, sort_field, subquery, to_columns;
