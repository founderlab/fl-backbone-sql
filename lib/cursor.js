...
(function() {
  var COMPARATORS, COMPARATOR_KEYS, Knex, SqlAst, SqlCursor, _, _appendCondition, _appendConditionalWhere, _appendLimits, _appendSelect, _appendSort, _appendWhere, _appendWhereAst, _columnName, _extractCount, _joinToRelation, _parseSortField, _prefixColumns, _tablePrefix, _unjoinResults, buildQueryFromAst, ref, sync,
  ...
  _joinToRelation = function(query, model_type, relation) {
  ...
  _unjoinResults = function(raw_json, ast, parseJson) {
    var found, i, join, json, key, len, match, model_json, model_type, ref1, related_json, related_model_type, relation_key, reverse_relation_schema, row, row_relation_json, value;
