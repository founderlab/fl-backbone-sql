...
(function() {
  ...
  _appendSelect = function(query, model_type, fields) {
  ...
  module.exports = SqlCursor = (function(superClass) {
    ...
    SqlCursor.prototype.queryToJSON = function(callback) {
      var $columns, $fields, ast, base, err, error, from_columns, i, key, len, query, query_old, rank_field, ref1, ref2, ref3, related_model_type, related_wheres, relation, sort_dir, sort_field, subquery, to_columns;
