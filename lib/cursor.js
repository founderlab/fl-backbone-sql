...
(function() {
  ...
  module.exports = SqlCursor = (function(superClass) {
    ...
    SqlCursor.prototype.execUnique = function(callback) {
      var ast, err, query, rank_field, ref1, ref2, sort_dir, sort_field, subquery;
      try {
        ast = new Ast({
          find: this._find,
          cursor: this._cursor,
        ...
        if (_.difference(ast.select, this._cursor.$unique).length === 0) {
          ...
          ref2 = Utils.parseSortField(((ref1 = ast.sort) != null ? ref1[0] : void 0) || 'id'), sort_field = ref2[0], sort_dir = ref2[1];
