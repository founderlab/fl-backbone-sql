...
(function() {
  var Ast, COMPARATORS, COMPARATOR_KEYS, Knex, SqlCursor, _, _appendCondition, _appendConditionalWhere, _appendLimits, _appendSelect, _appendSort, _appendWhere, _appendWhereAst, _columnName, _extractCount, _joinToRelation, _parseSortField, _prefixColumns, _tablePrefix, _unjoinResults, buildQueryFromAst, ref, sync,
  ...
  module.exports = SqlCursor = (function(superClass) {
    ...
    SqlCursor.prototype._joinedResultsToJSON = function(raw_json) {
      var found, i, include_key, json, k, key, len, len1, match, model_json, ref1, related_json, related_model_type, reverse_relation_schema, row, row_relation_json, value;
      if (!(raw_json && raw_json.length)) {
        return raw_json;
      }
      json = [];
