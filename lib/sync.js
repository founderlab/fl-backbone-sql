...
(function() {
  ...
  SqlSync = (function() {
    ...
    SqlSync.prototype.create = function(model, options) {
      var json;
      json = this.parseJSON(model.toJSON());
      return this.getTable('master').insert(json, 'id').asCallback((function(_this) {
        return function(err, res) {
          ...
          json.id = res[0];
          _this.backbone_adapter.nativeToAttributes(json, _this.schema);
          return options.success(json);
        };
      })(this));
    };
    ...
    SqlSync.prototype.update = function(model, options) {
      var json;
      json = this.parseJSON(model.toJSON());
      return this.getTable('master').where('id', model.id).update(json).asCallback((function(_this) {
        return function(err, res) {
          if (err) {
            return options.error(err);
          }
    ...
    SqlSync.prototype.parseJSON = function(json) {
